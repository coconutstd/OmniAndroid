...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.example.omniandroid.SettingActivity.this, com.example.omniandroid.MainActivity.class);
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CommonAction.openAuthMain(com.example.omniandroid.SettingActivity.this);
            }
        });
    }

    private void saveSettings() {
        com.example.omniandroid.Util.setPreference(getApplicationContext(), "preferlanguage", String.valueOf(com.example.omniandroid.Util.nPreferLanguage));
        com.example.omniandroid.Util.setPreference(getApplicationContext(), "grade", String.valueOf(com.example.omniandroid.Util.nGrade));
    }

    private void setSpinnerCustomerGrade() {

        customergrade = findViewById(R.id.customergrade);
        customergrade.setSelection(Integer.valueOf(com.example.omniandroid.Util.getPreferenceString(getApplicationContext(), "grade", "0")));
        customergrade.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                com.example.omniandroid.Util.nGrade = i;
            }
    ...
    private void setSpinnerDestinationLanguage() {
        ...
        translatedlanguage.setSelection(Integer.valueOf(com.example.omniandroid.Util.getPreferenceString(getApplicationContext(), "preferlanguage", "7")));//english
        translatedlanguage.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                com.example.omniandroid.Util.nPreferLanguage = i;
            }
